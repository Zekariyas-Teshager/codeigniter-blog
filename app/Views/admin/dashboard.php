        ...
        <div class="card-body">
            <?php if (!empty($recent_posts)): ?>
                ...
                <div class="mt-3 text-center">
                    <a href="<?= base_url('posts/my-posts') ?>" class="btn btn-outline-primary">View All Posts</a>
                </div>
            <?php else: ?>
                <div class="text-center py-4">
                    ...
                    <a href="<?= base_url('posts/create') ?>" class="btn btn-primary">Write Your First Post</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body text-center py-5">
            ...
            <div class="d-flex justify-content-center gap-3">
                <a href="<?= base_url('posts') ?>" class="btn btn-primary">Browse Posts</a>
                <a href="<?= base_url('dashboard/profile') ?>" class="btn btn-outline-secondary">Update Profile</a>
            </div>
        </div>
    </div>
<?php endif; ?>