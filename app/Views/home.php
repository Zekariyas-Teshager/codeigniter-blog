...
<div class="row">
        ...
        <?php else: ?>
            <?php foreach ($posts as $post): ?>
                <div class="card post-card mb-4">
                    <div class="card-body">
                        <h2 class="card-title">
                            <a href="<?= site_url('post/' . $post['slug']) ?>" class="text-decoration-none">
                                <?= esc($post['title']) ?>
                            </a>
                        </h2>
                        ...
                        <div class="text-muted mb-3">
                            <small>
                                ...
                                <a href="<?= site_url('category/' . $post['category_slug']) ?>" class="text-muted">
                        ...
                        <a href="<?= site_url('post/' . $post['slug']) ?>" class="btn btn-outline-primary btn-sm">
    ...
    <div class="col-lg-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <p>Welcome to our blog! Here you'll find interesting articles about various topics.</p>
                <?php if (!is_logged_in()): ?>
                    <div class="d-grid gap-2">
                        <a href="<?= site_url('register') ?>" class="btn btn-primary">Join Our Community</a>
            ...
            <div class="card-body">
                <div class="list-group list-group-flush">
                    <?php foreach ($categories as $category): ?>
                        <a href="<?= site_url('category/' . $category['slug']) ?>" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                            <?= esc($category['name']) ?>
